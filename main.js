...
function renderCourses() {
  const courses = [
    { title: 'UX/UI Dizayn', desc: 'İstifadəçi təcrübəsi və istifadəçi interfeysi dizaynının sirlərini öyrənin. Figma-da real layihələr. Müasir dizayn trendləri.', icon: '📐' },
    { title: 'Qrafik Dizayn', desc: 'Adobe Photoshop və Illustrator ilə vizual kommunikasiya sənətini mənimsəyin. Brandinq, sosial media postları və daha çoxu.', icon: '🎨' },
    { title: 'Frontend Proqramlaşdırma', desc: 'HTML, CSS, JavaScript və müasir freymvörklərlə (React və ya Vue) göz oxşayan və interaktiv veb saytlar yaradın.', icon: '💻' },
    { title: 'Backend Proqramlaşdırma', desc: 'Server, məlumatlar bazası strukturu (Node.js, Python və ya PHP) öyrənərək güclü və təhlükəsiz veb sistemləri hazırlayın.', icon: '⚙️' },
    { title: 'SMM (Sosial Media Marketinq)', desc: 'Brendin rəqəmsal mövcudluğunu artırın. Reklam strategiyaları, məzmun planlaması və hədəf kütlə analizini öyrənin.', icon: '📱' }
  ];
...
// Optional: scroll animation logic can be added later
